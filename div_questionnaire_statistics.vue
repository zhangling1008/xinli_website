<template>
	<div class="diy_details_box diy_div_questionnaire_statistics">
		<div class="warp">
			<div class="container">
	...
	export default {
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					source_table: "questionnaire_statistics",
					source_field: "questionnaire_statistics_id",
					source_id: this.obj["questionnaire_statistics_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/questionnaire_statistics/set?questionnaire_statistics_id=' + _this.obj["questionnaire_statistics_id"], {
								praise_len
							}, (res) => {
								if(res.result){
