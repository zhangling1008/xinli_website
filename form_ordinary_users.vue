<template>
	<div>
		<b-form-group v-if="$check_register_field('add','full_name','/ordinary_users/view')" id="input-group-0" label="姓名" label-for="input-0">
			<b-form-input id="input-0" v-model="form['full_name']" type="text" placeholder="姓名" trim></b-form-input>
		</b-form-group>
		<b-form-group v-if="$check_register_field('add','gender','/ordinary_users/view')" id="input-group-1" label="性别" label-for="input-1">
